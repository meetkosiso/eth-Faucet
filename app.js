...
function renderApp(){
  ...
  render([
    ...
    h('nav.navbar.navbar-default', [
      h('h1.container-fluid', 'MetaMask BEZ Faucet')
    ]),
    ...
    h('section.container', [
      ...
      h('div.panel.panel-default', [
        ...
        h('div.panel-body', [
          ...
          h('button.btn.btn-success', 'request 1 BEZ from faucet', {
            style: {
              margin: '4px',
            },
      ...
      h('div.panel.panel-default', [
        ...
        h('div.panel-body', [
          ...
          h('button.btn.btn-warning', '1 BEZ', {
            style: {
              margin: '4px',
            },
            // disabled: state.userAddress ? null : true,
          ...
          h('button.btn.btn-warning', '10 BEZ', {
            style: {
              margin: '4px',
            },
            // disabled: state.userAddress ? null : true,
          ...
          h('button.btn.btn-warning', '100 BEZ', {
            style: {
              margin: '4px',
            },
            // disabled: state.userAddress ? null : true,
